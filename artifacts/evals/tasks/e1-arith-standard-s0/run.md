# eval-tasks — e1-arith-standard-s0

- checkpoint: `artifacts/campaigns/e1/arith-standard-s0/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.865 | 2.5/10.4 | [curve](curve_arith.png) |
