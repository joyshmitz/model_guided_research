# eval-tasks — e1-arith-surreal-s6

- checkpoint: `artifacts/campaigns/e1/arith-surreal-s6/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.854 | 2.5/10.9 | [curve](curve_arith.png) |
