# eval-tasks — pilot1r-rel-simplicial-s0

- checkpoint: `artifacts/campaigns/pilot1/rel-simplicial-s0/checkpoints` @ step 241
...
|---|---|---|---|---|
| rel | 0.135 | 0.021 | 2.9/22.3 | [curve](curve_rel.png) |
