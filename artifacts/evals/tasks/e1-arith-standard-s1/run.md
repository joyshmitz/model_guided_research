# eval-tasks — e1-arith-standard-s1

- checkpoint: `artifacts/campaigns/e1/arith-standard-s1/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.812 | 2.4/11.7 | [curve](curve_arith.png) |
