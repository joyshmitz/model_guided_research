# eval-tasks — pilot1r-arith-standard-s1

- checkpoint: `artifacts/campaigns/pilot1/arith-standard-s1/checkpoints` @ step 241
...
|---|---|---|---|---|
| arith | 0.448 | 0.500 | 2.8/7.7 | [curve](curve_arith.png) |
