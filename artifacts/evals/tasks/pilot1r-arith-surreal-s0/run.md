# eval-tasks — pilot1r-arith-surreal-s0

- checkpoint: `artifacts/campaigns/pilot1/arith-surreal-s0/checkpoints` @ step 241
...
|---|---|---|---|---|
| arith | 0.448 | 0.500 | 2.8/6.7 | [curve](curve_arith.png) |
