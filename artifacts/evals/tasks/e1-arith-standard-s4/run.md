# eval-tasks — e1-arith-standard-s4

- checkpoint: `artifacts/campaigns/e1/arith-standard-s4/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.802 | 2.5/12.2 | [curve](curve_arith.png) |
