# eval-tasks — e1-arith-surreal-s5

- checkpoint: `artifacts/campaigns/e1/arith-surreal-s5/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.844 | 2.5/10.2 | [curve](curve_arith.png) |
