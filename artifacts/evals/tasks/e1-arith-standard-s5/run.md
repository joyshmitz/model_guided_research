# eval-tasks — e1-arith-standard-s5

- checkpoint: `artifacts/campaigns/e1/arith-standard-s5/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.802 | 2.5/12.0 | [curve](curve_arith.png) |
