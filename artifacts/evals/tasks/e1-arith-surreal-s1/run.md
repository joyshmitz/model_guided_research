# eval-tasks — e1-arith-surreal-s1

- checkpoint: `artifacts/campaigns/e1/arith-surreal-s1/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.792 | 2.5/11.5 | [curve](curve_arith.png) |
