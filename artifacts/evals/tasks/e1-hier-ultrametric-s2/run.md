# eval-tasks — e1-hier-ultrametric-s2

- checkpoint: `artifacts/campaigns/e1/hier-ultrametric-s2/checkpoints` @ step 1096
...
|---|---|---|---|---|
| hier | 0.000 | 0.000 | 1.6/34.1 | [curve](curve_hier.png) |
