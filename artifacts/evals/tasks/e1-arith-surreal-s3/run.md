# eval-tasks — e1-arith-surreal-s3

- checkpoint: `artifacts/campaigns/e1/arith-surreal-s3/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.875 | 2.5/11.0 | [curve](curve_arith.png) |
