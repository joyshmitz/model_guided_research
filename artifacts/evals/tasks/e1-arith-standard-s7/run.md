# eval-tasks — e1-arith-standard-s7

- checkpoint: `artifacts/campaigns/e1/arith-standard-s7/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.823 | 2.5/12.5 | [curve](curve_arith.png) |
