# eval-tasks — pilot1r-rel-simplicial-s1

- checkpoint: `artifacts/campaigns/pilot1/rel-simplicial-s1/checkpoints` @ step 241
...
|---|---|---|---|---|
| rel | 0.135 | 0.021 | 2.9/20.7 | [curve](curve_rel.png) |
