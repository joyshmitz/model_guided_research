# eval-tasks — e1-dyck-braid-s19-r2

- checkpoint: `/data/projects/model_guided_research/artifacts/campaigns/e1/dyck-braid-s19/checkpoints` @ step 1096
...
|---|---|---|---|---|
| dyck | 0.521 | 0.510 | 2.9/4.5 | [curve](curve_dyck.png) |
