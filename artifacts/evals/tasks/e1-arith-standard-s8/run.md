# eval-tasks — e1-arith-standard-s8

- checkpoint: `artifacts/campaigns/e1/arith-standard-s8/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.865 | 2.5/11.4 | [curve](curve_arith.png) |
