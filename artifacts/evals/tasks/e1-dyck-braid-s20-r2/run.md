# eval-tasks — e1-dyck-braid-s20-r2

- checkpoint: `/data/projects/model_guided_research/artifacts/campaigns/e1/dyck-braid-s20/checkpoints` @ step 1096
...
|---|---|---|---|---|
| dyck | 0.635 | 0.594 | 2.9/4.4 | [curve](curve_dyck.png) |
