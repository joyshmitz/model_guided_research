# eval-tasks — e1-arith-standard-s3

- checkpoint: `artifacts/campaigns/e1/arith-standard-s3/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.823 | 2.5/10.2 | [curve](curve_arith.png) |
