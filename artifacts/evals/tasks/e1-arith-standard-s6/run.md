# eval-tasks — e1-arith-standard-s6

- checkpoint: `artifacts/campaigns/e1/arith-standard-s6/checkpoints` @ step 1096
...
|---|---|---|---|---|
| arith | 1.000 | 0.865 | 2.4/11.9 | [curve](curve_arith.png) |
