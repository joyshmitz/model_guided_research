# eval-tasks — pilot1r-hier-standard-s2

- checkpoint: `artifacts/campaigns/pilot1/hier-standard-s2/checkpoints` @ step 241
...
|---|---|---|---|---|
| hier | 0.042 | 0.021 | 3.0/23.6 | [curve](curve_hier.png) |
